                ...
                <div class="col">
                    ...
                    {!! Form::open(['url' => '/student/' . $id . '/scoresheet/' . $session . '/' . $term . '/store']) !!}
                        ...
                        @foreach($data as $item)
                            <tbody>
                                <tr>
                                    <td scope="row"><input type="hidden" name="subject_id[]" value="<?php echo $item->id; ?>"><?php echo $item->id; ?></td>
                                    <td class="col-5"><input type="hidden" name="subjects[]" value="<?php echo $item->name ?>"><?php echo $item->name ?></td>
                                    <td ><input class="text-center" type="text" name="CA1[]" ></td>
                                    <td ><input class="text-center" type="text" name="CA2[]"></td>
                                    <td ><input class="text-center" type="text" name="CA3[]"></td>
                                    <td ><input class="text-center" type="text" name="CA4[]"></td>
                                    <td ><input class="text-center" type="text" name="CA5[]"></td>
                                    <td ><input class="text-center" type="text" name="exam[]"></td>
                                </tr>
                            </tbody>
                        @endforeach
                        </table>
